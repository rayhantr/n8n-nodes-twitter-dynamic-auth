...
export class TwitterDynamicAuth implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'TwitterDynamicAuth',
		name: 'TwitterDynamicAuth',
		icon: 'file:twitter.svg',
		group: ['input', 'output'],
		version: 1,
		description: 'Consume Twitter API using dynamic auth',
